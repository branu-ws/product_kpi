"""Work (施工管理) Plus Fan / Proactive 顧客の機能別月次ヒートマップ。"""
...
build_heatmap(
    ...
    title="Work (施工管理) Plus Fan / Proactive 顧客  機能別月次ヒートマップ",
    out_path=Path(__file__).parent.parent / "output/html/work_company_feature_heatmap.html",
)
